...
timeCalib = DQMEDAnalyzer('Phase2TrackerBXHistogram',
    ...
    CBCPulseShapeParameters = cms.vdouble(-3.0, 16.043703, 99.999857, 40.571650, 2.0, 1.2459094),
    MPAPulseShapeParameters = cms.vdouble(-3.0, 24.36077712, 1.36421689, 1.83230652),
    BXRange = cms.int32(5),
